        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TermDate = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    BuyerTaxId = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    SupplierTaxId = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    InvoiceCost = table.Column<decimal>(type: "numeric(18,4)", precision: 18, scale: 4, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Invoice_User_BuyerId",
                        column: x => x.BuyerId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Invoice_User_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Payment_User_FinancialInstitutionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payment_FinancialInstitutionId",
                table: "Payment",
